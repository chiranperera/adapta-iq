export default function About() {
  return (
    <div className="min-h-screen bg-white">
      {/* Header placeholder - same as Index */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <a href="/about" className="text-adaptaiq-blue-500 font-bold text-sm">
                About
              </a>
              <a href="/why" className="text-adaptaiq-gray-600 font-bold text-sm hover:text-adaptaiq-blue-500 transition-colors">
                Why
              </a>
      ...
      <div className="max-w-4xl mx-auto px-4 py-24 text-center">
        <h1 className="text-4xl font-bold text-adaptaiq-gray-900 mb-8">About AdaptaIQ</h1>
